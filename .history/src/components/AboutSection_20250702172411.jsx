        ...
        <div className={styles.row}>
          <div className={styles.textCol}>
            <div className={styles.textWrapper}>
              ...
              <a className={styles.button} href="#">Online Application Form <i className="bi bi-arrow-up-right-square-fill"></i></a>

              <h2 className={styles.heading}>Step 2: <br /> Application Fee</h2>
              <p className={styles.lead}>
                Pay the &#8358; 2,500 nonrefundable Post UTME application fee.
              </p>
              <a className={styles.button} href="/payment-page">Pay Application Fee <i className="bi bi-arrow-up-right-square-fill"></i></a>
              <PaymentAccordion />
            </div>
          </div>
